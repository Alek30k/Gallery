...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#050505] text-white selection:bg-pink-500/30 overflow-x-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-gradient-to-b from-pink-900/20 via-transparent to-transparent blur-[120px] pointer-events-none" />
        ...
        <section className="flex flex-col items-center justify-center pt-24 pb-16 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <div className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-white/5 border border-white/10 transition-hover hover:bg-white/10">
              ...
              <div className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-white/5 border border-white/10 transition-hover hover:bg-white/10">
                ...
                <span className="text-sm font-medium">100% Hecho a mano</span>
              </div>
            </div>
          </motion.div>
        </section>
      ...
      {/* BOTÓN WHATSAPP FLOTANTE PROFESIONAL */}
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-8 right-8 z-50 flex items-center gap-3 bg-[#25D366] hover:bg-[#20ba5a] text-white px-6 py-4 rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.3)] transition-all group"
      >
